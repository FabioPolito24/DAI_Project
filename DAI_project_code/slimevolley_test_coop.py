...
agent_right = Agent(gamma=0.99, epsilon=0, lr=5e-4,
                    ...
                    batch_size=64, eps_dec=3e-6, replace=100, path_eval='./dueling_ddqn/slimevolley_dueling_ddqn_q_eval_coop_bounce_7', greedy=True)
...
video_recorder = None
video_recorder = VideoRecorder(env, "./video/coop_14.mp4", enabled=True)
